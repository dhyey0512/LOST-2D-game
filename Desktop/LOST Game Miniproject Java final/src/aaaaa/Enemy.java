...
public class Enemy {
	...
	public static void update() {
            ...
            for (Enemy i: enemies) {
                    ...
                    i.follow();
                    i.centerX += i.speedX;
                    i.speedX = i.bg.getSpeedX() * 4 + i.movementSpeed;
                    i.r.setBounds(i.centerX - 50, i.centerY-12, 75, 60);
        ...
        public void follow() {
                ...
                else if (StartingClass.getRobot().getCenterX() - centerX > 600){
                    this.movementSpeed = 0;
                }

		else if (Math.abs(StartingClass.getRobot().getCenterX() - centerX) < 10) {
			this.movementSpeed = 0;
		}
